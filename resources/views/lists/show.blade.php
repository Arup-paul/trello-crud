                        ...
                        <div class="card card-statistic-1">
                            <div class="card-wrap">
                                <div class="card-body py-2"  >
                                    <h6>{{$card->name ?? ""}}</h6>
                                    <a href="{{route('card.show',$card->id)}}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('card.store')}}" class="ajaxform_with_redirect" method="post">
                        ...
                        <div class="mb-3">
                            <textarea name="description" id="description" class="form-control" id="" cols="30" placeholder="Enter Card Description" rows="10"></textarea>
                        </div>
